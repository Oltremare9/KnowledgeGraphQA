...
/**
 * Description: <br/>
 * date: 2021/2/17 22:26<br/>
 *
 * @author HaoNanWang<br />
 * @since JDK 11
 */

@RelationshipEntity(type = "humanOf",value = "humanOf")
public class HumanOf<S extends BaseNode,E extends BaseNode> extends BaseRelation {
