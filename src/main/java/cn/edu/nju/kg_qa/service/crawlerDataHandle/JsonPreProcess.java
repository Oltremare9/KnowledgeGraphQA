...
//        for(CrawlerJsonList crawlerJsonList:list){
//            System.out.println(crawlerJsonList.toString());
//        }
    }
    ...
    public static void main(String args[]) {
        ...
        JsonPreProcess readJson = new JsonPreProcess();
        File file = new File("C:\\Users\\11346\\Desktop\\al.jl");
        try {
