...
public class RedisUtil {
    ...
    /**
     * score的增加or减少 zincrby 当元素不存在时，则会新插入一个
     *
     * @param key
     * @param value
     * @param score
     * @return
     */
    public Double zIncrScore(String key, String value, long score) {
        return redisTemplate.opsForZSet().incrementScore(key, value, score);
    }

    /**
     * score的增加1 当元素不存在时，则会新插入一个
     *
     * @param key
     * @param value
     * @return
     */
    public Double zIncrScore(String key, String value) {
